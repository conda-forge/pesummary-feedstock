...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6146&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pesummary-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pesummary` can be installed with `conda`:
...
```
mamba install pesummary
```

It is possible to list all of the versions of `pesummary` available on your platform with `conda`:
...
```
mamba search pesummary --channel conda-forge
```
...
mamba repoquery search pesummary --channel conda-forge

# List packages depending on `pesummary`:
mamba repoquery whoneeds pesummary --channel conda-forge

# List dependencies of `pesummary`:
mamba repoquery depends pesummary --channel conda-forge
```
